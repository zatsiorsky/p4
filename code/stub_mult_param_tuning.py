...
if __name__ == '__main__':
	...
	for eta, gamma, epsilon, md, my, ms in params: 
		...
		if os.path.isfile('csvs_vel_35_54_120/' + name  + ".csv"):
			continue
		...
		df.to_csv('csvs_vel_35_54_120/' + name + ".csv", index=0)
		...
		with open("grid_results_vel_35_54_120.csv", "a") as myfile:
