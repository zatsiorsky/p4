...
if __name__ == '__main__':
	...
	for eta, gamma, epsilon, md, my, ms in params: 
		...
		if os.path.isfile('csvs200/' + name  + ".csv"):
			continue
		...
		df.to_csv('csvs200/' + name + ".csv", index=0)
		...
		with open("grid_results200.csv", "a") as myfile:
		...
		if i % 25 == 0:
			...
			print "Combos 2 : {},  Elapsed time: {}".format(i, str(elapsed))
