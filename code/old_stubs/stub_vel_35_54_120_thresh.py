...
if __name__ == '__main__':
	...
	for eta, gamma, epsilon, md, my, ms in params: 
		...
		if os.path.isfile('csvs_vel_35_54_12_thresh/' + name  + ".csv"):
			continue
		...
		df.to_csv('csvs_vel_35_54_12_thresh/' + name + ".csv", index=0)
		...
		with open("grid_results_vel_35_54_120_thresh.csv", "a") as myfile:
